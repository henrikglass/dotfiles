...
" jumplist && tag (ctag) navigation
nnoremap <C-o> <C-o>
nnoremap <Tab> <C-i>
"nnoremap <C-i> <Nop>
"nnoremap <C-o> <Nop>
nnoremap <C-f> <C-]>
nnoremap <C-c> :try \| tnext \| catch \| tfirst \| endtry<CR>
nnoremap <C-g> :tselect<CR>
...
" tag generation
:command Ctags !ctags -R --c-kinds=+p
...
:autocmd BufWritePost *.cpp,*.hpp,*.c,*.h,*.adb,*.ads call system('test -f tags && ctags -R --c-kinds=+p')
