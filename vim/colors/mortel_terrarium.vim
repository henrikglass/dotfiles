...
set t_Co=256
let g:colors_name = "mortel_terrarium"
...
hi Directory guifg=#d75f5f guibg=NONE guisp=NONE gui=NONE ctermfg=60 ctermbg=NONE cterm=NONE
...
hi MatchParen guifg=#d75f5f guibg=NONE guisp=NONE gui=NONE ctermfg=1 ctermbg=NONE cterm=BOLD
...
hi IncSearch guifg=#1e1e1e guibg=#e04050 guisp=#e04050 gui=NONE ctermfg=235 ctermbg=1 cterm=NONE
hi WildMenu guifg=NONE guibg=#e04050 guisp=#e04050 gui=NONE ctermfg=NONE ctermbg=248 cterm=NONE
...
" hi TabLineSel guifg=#1e1e1e guibg=#e04050 guisp=#e04050 gui=NONE ctermfg=235 ctermbg=1 cterm=NONE
...
hi Todo guifg=#e04050 guibg=NONE guisp=#e04050 gui=NONE ctermfg=189 ctermbg=1 cterm=BOLD
hi Special guifg=#b5b3aa guibg=NONE guisp=NONE gui=NONE ctermfg=144 ctermbg=NONE cterm=NONE
" TODO
" hi StatusLine guifg=#1e1e1e guibg=#e04050 guisp=#e04050 gui=NONE ctermfg=235 ctermbg=1 cterm=NONE

hi PMenuSel guifg=#1e1e1e guibg=#d0c0a0 guisp=#d0c0a0 gui=NONE ctermfg=235 ctermbg=1 cterm=NONE
hi Search guifg=#1e1e1e guibg=#e04050 guisp=#e04050 gui=NONE ctermfg=235 ctermbg=1 cterm=NONE
...
hi PMenu guifg=#f0e0c0 guibg=#e04050 guisp=#292929 gui=NONE ctermfg=235 ctermbg=66 cterm=NONE
...
hi debugPC guifg=#f0e0c0 guibg=#e04050 guisp=#F9F9FF gui=NONE ctermfg=235 ctermbg=189 cterm=NONE
